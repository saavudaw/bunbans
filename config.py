...
if ENV:
    ...
    EVENT_LOGS = os.environ.get("EVENT_LOGS", "-1002094585538")
    INFOPIC = bool(os.environ.get("INFOPIC", "True"))
    MESSAGE_DUMP = os.environ.get("MESSAGE_DUMP", None)
    DB_NAME = os.environ.get("DB_NAME", "jarvismanager")
    ...
    try:
        DEMONS = set(int(x) for x in os.environ.get("DEMONS", "5759576247").split())
    except ValueError:
    ...
    try:
        WOLVES = set(int(x) for x in os.environ.get("WOLVES", "5759576247").split())
    except ValueError:
